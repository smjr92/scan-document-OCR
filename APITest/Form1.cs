...
namespace OCRAPITest
{
    public partial class Form1 : Form
    {
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    form.Add(new StringContent("61a9f1db0f88957"), "apikey"); //The "helloworld" key works, but it has a very low rate limit. You can get your won free api key at https://ocr.space/OCRAPI
        ...
        {
            txtResult.Text = ResultJsonString.Replace("\\r", "").Replace("\\n", "");
            txtResult.Text = ResultJsonString.Replace("-", "/");
        }
        ...
        public void RecognizeGoogleApi()
        {
            ...
            annotate.GetText(ImagePath, getGoogleSelectedLanguage(), cmbType.SelectedItem + "");
        ...
        {
            TextWriter txt = new StreamWriter("C:\\tmp\\info.txt");
            txt.Write(txtResult.Text);
            txt.Close();

            string[] arquivo = File.ReadAllLines("C:\\tmp\\info.txt");

            //Linha a ser lida, podendo variar, basta apenas informar
            int linha0 = 1;
            int linha1 = 5;
            int linha2 = 6;
            ...
            string nas;
            //Lendo o nome José
            nome = arquivo[linha0 - 1];
            cpf = arquivo[linha1 - 1].Replace("-","");
            nas = arquivo[linha2 - 1].Replace(" ","/");

            var nasCorrigida = Convert.ToDateTime(nas).ToString("yyyy-MM-dd");
