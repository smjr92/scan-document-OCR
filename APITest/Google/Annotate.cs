...
namespace OCRAPITest.Google
{
    public class Annotate
    {
        ...
        private GoogleCredential CreateCredential()
        {
            ...
            using (var stream = new FileStream(Application.StartupPath + "\\61a9f1db0f88957.json", FileMode.Open, FileAccess.Read))
            {
        ...
        /// <returns></returns>
        public string GetText(string imgPath, string language, string type)
        {
